  ...
  regiaoValor.addEventListener("change", () => {
    ...
    switch (regiaoValor.value) {
      case "n":
        ...
        <img src="../assets/images/foto-enchente-amazonica.avif" alt="Enchente na Amazônia">
        </div>
      ...
      case "no":
        ...
        <img src="../assets/images/chuva-nordeste.webp" alt="Enchente na região Nordeste">
        </div>
        <div class="saida"><button class="btnSaida">_________________</button></div>
        `;
        break;
      case "co":
        ...
        <img src="../assets/images/chuva-co.webp" alt="Enchente na região Centro-Oeste">
        </div>
        <div class="saida"><button class="btnSaida">_________________</button></div>
        `;
        break;
      case "sud":
        ...
        <div class="textImg">
          ...
          <img src="../assets/images/enchente-sudeste.jpg" alt="Enchente na região Sudeste">
          </div>
          <div class="saida"><button class="btnSaida">_________________</button></div>
        `;
        break;
      case "sul":
        ...
        <div class="textImg">
          ...
          <img src="../assets/images/rio-grande-do-sul-4.webp" alt="Enchente na região Sul">
        </div>
        <div class="saida"><button class="btnSaida">_________________</button></div>
        `;
        break;
